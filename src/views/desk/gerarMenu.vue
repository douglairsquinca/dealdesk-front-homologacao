<template>
  <div>
    <div class="modal-content bg-dark rf_texto py-4">
        ...
        <form @submit.prevent="onSubmit">
          <div class="card rf_bg_form mt-4">
            ...
            <div class="row g-2 p-2">
              ...
              <!-- <div class="col">
                <div class="form-floating">
                  <button type="button" class="btn btn-secondary mt-3 " data-bs-toggle="modal" data-bs-target="#ModalTrocarVendedor" @click="trocar_vendedor">
                    Trocar Vendedor
                  </button>
                </div>
              </div> -->
                    ...
                    <table class="table rf_texto bg-dark">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="form-floating">
                              <input type="text" class="form-control-plaintext rf_texto" v-model="entrada_1"
                                v-on:blur="calcular_real_1" @input="entrada_1 = formatarValor(entrada_1)" />
                          ...
                          <td>
                            <div class="form-floating">
                              <input type="text" class="form-control-plaintext rf_texto" v-model="entrada_1_perc"
                          ...
                          <td>
                            <div class="form-floating">
                              <input type="text" class="form-control-plaintext rf_texto" v-model="entrada_2"
                                v-on:blur="calcular_real_2" @input="entrada_2 = formatarValor(entrada_2)" />
                              <label class="rf_texto">Entrada R$</label>
                            </div>
                          </td>
                          <td>
                            <div class="form-floating">
                              <input type="text" class="form-control-plaintext rf_texto" v-model="entrada_2_perc"
                          ...
                          <td>
                            <div class="form-floating">
                              <input type="text" class="form-control-plaintext rf_texto" v-model="entrada_3"
                                v-on:blur="calcular_real_3" @input="entrada_3 = formatarValor(entrada_3)" />
                              <label class="rf_texto">Entrada R$</label>
                            </div>
                          </td>
                          <td>
                            <div class="form-floating">
                              <input type="text" class="form-control-plaintext rf_texto" v-model="entrada_3_perc"
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-secondary m-1" data-bs-toggle="modal" data-bs-target="#ModalGerarMenu"
          :disabled="inserir_veiculo" @click="carregarDadosMenu()">
          GERAR MENU
        </button>
      ...
      <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content bg-dark rf_texto">
          <div class="modal-header">
            ...
            <button class="btn btn-secondary btn-lg p-1 mt-1" type="button" 
            data-bs-dismiss="modal" aria-label="Close"> Fechar</button>
          </div>
            <div class="modal-body">
              <div class="col">
                <div class="form-floating">
                  <select class="form-select rf_bg_form rf_texto"  v-model="vendedor_inicial"
                    >
                    <option v-for="item in vendedor" :value="item.id" :key="item.id" >
                      {{ item.username }}
  ...
  methods: {
    ...
    async reimprimirMenu() {
      try {
        ...
        //   parseFloat(data?.data?.rows[0]?.adicional ?? 0)
        // );
        this.g_menu_val_veiculo = this.currency(data?.data?.rows[0]?.val_sugerido_venda ?? 0);
      ...
      try {
        ...
        userService.getVendedorOrdenado(params).then((response) => {
          ...
          users.forEach(function (item) {
            ...
            } else if (item.status_vendedor == 0) {
              status_vend = "Indisponível";
            }

            const dados_vendedor = {
              id: item.id,
