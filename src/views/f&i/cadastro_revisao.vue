<template lang="pt-br">
    ...
    <NavgatorFI ref="navgator" :barraTitulo="' F&I - Revisão Programada'" :titulo="'revisão'"/>
    <div class="card card-filtro">
      <div class="row g-2 p-2">
        <div class="card-title gy-4">
          <i class="bi bi-speedometer2 fs-5 icone_filtro"><span class="texto_filtro">Dados da Revisão</span></i>         
        </div>
      </div>
      <div class="row g-2 p-2">
        <div class="col-2">
   ...
   <div class="card card-filtro">
    ...
    <div class="card card-tabela g-2 p-2 rf_margin">
      <table class="table rf_texto">
        ...
        <tbody>
          <tr>
            <td>Revisão Pré-Paga 10-20-30</td>
