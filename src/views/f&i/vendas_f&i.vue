<template>
    ...
    <NavgatorFI ref="navgator" :barraTitulo="' F&I - Vendas'" :titulo="'vendas'" />
        ...
        <div class="row g-2 p-2">
            <div class="col-2">
                <div class="d-flex justify-content-between mb-3">
                    <select class="form-select rf_bg_form rf_texto" v-model="selectedFilter"
        ...
        <table class="table rf_texto">
            ...
            <tbody>
                <tr>
                    ...
                    <td>Ação</td>
                    <td>
                        <button class="dropdown-toggle-icon" data-bs-toggle="modal" data-bs-target="#ModalFI"
    ...
    <!--Modal Vendas F&I-->
    <div class="modal modal-vendas fade" id="ModalFI" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2"
        tabindex="-1">
            ...
            <div class="card modal-content  rf_texto">
                ...
                <div class="modal-body">
                    ...
                    <div class="card card-vendas">
                        <div class="row g-2 p-2">
                            <div class="card-title gy-4">
                                <i class="bi bi-journal-text fs-5 icone_filtro"><span class="texto_filtro"><strong>Dados do Atendimento</strong></span></i>
                            </div>
                        </div>
                        <div class="row g-2 p-2">                         
                            <div class="col-2">
                                <div class="form-floating">
                                    <input type="text" disabled class="form-control rf_bg_form rf_texto" v-model="filtroPlaca"
                    ...
                    <div class="card card-vendas">
                        <div class="row g-2 p-2">
                            <div class="card-title gy-4">
                                <i class="bi bi-journal-text fs-5 icone_filtro"><span class="texto_filtro"><strong>Dados do Veículo</strong></span></i>
                            </div>
                        </div>
                        <div class="row g-2 p-2">
                            <div class="col-2">
                    ...
                    <div class="card card-vendas">
                        <div class="row g-2 p-2">
                            <div class="card-title gy-4">
                                <i class="bi bi-journal-text fs-5 icone_filtro"><span class="texto_filtro"><strong>Dados do Financiamento</strong></span></i>
                            </div>
                        </div>
                        <div class="row g-2 p-2">
                            <div class="col">
                    ...
                    <div class="row">
                                ...
                                <div class="col-1">
                                    <ul class="nav nav-item justify-content-end">
                                        <li class="nav-item dropdown">
                                            <button class="btn-card-ouro" data-bs-toggle="dropdown"
                                                aria-expanded="true">
                                                <i class="bi bi-eye"></i>
                                            </button>
                                            <ul class="btn-kits-ouro dropdown-menu  dropdown-menu-end ">
                                                ...
                                                <li class="nav-item">
                                                    <strong><i class="bi bi-check2-circle"> Teste</i></strong>
                                                </li>
                                                <li class="nav-item">
                                                    <strong><i class="bi bi-check2-circle"> Teste</i></strong>
                                                </li>
                        ...
                        <div class="card card-prata col">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-1">
                                    <ul class="nav nav-item justify-content-end">
                                        <li class="nav-item dropdown">
                                            <button class="btn-card-prata" data-bs-toggle="dropdown"
                                                aria-expanded="true">
                                                <i class="bi bi-eye"></i>
                                            </button>
                        ...
                        <div class="card card-bronze col">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-1">
                                    <ul class="nav nav-item justify-content-end">
                                        <li class="nav-item dropdown">
                                            <button class="btn-card-bronze" data-bs-toggle="dropdown"
                                                aria-expanded="true">
                                                <i class="bi bi-eye"></i>
                                            </button>
                        ...
                        <div class="card card-customizado col">
                            <i class="bi bi-gem card-texto-vendas-customizado"> Pacote Customizado</i>
                            <!--Acessórios-->
                            <div class="row ">
                                <div class="col mt-3"><strong>Acessórios</strong></div>
                                <div class="col-1">
                                    <ul class="nav nav-item justify-content-end">
                                        <li class="nav-item dropdown">
                                            <button class="btn-card-customizado" data-bs-toggle="dropdown"
                                                aria-expanded="true">
                                                <i class="bi bi-eye"></i>
                                            </button>
                                            <ul class="btn-kits-customizado dropdown-menu  dropdown-menu-end ">
                                                <!-- Conteúdo do dropdown -->
                                                <li class="nav-item">
                                                    <strong><i class="bi bi-check2-circle"> Teste</i></strong>
                                                </li>
                            ...
                            <!--Valor-->
                            <div class="txt-card-valor"><strong>Valor</strong></div>
                            <div class="valor-card-customizado"><strong>R$ 9.500,00</strong></div>
                    ...
                    <div class="card card-vendas">
                        <div class="row g-2 p-2">
                            <div class="card-title gy-4">
                                <i class="bi bi-journal-text fs-5 icone_filtro"><span class="texto_filtro"><strong>Informações F&I</strong></span></i>
                            </div>
                        </div>
                        <div class="row g-2 p-2">
                            <div class="col">
                            ...
                            <div class="col-2 ">
                                <div class="input-group-append">
                                    <button class="btn btn-lg btn-filtro" type="button"
                                        @click="page = 1; retrievePropostas();">
                    ...
                    <div class="card card-vendas">
                        <div class="row g-2 p-2">
                            <div class="card-title gy-4">
                                <i class="bi bi-journal-text fs-5 icone_filtro"><span class="texto_filtro"> <strong>Ranqueamento F&I</strong></span></i>
                            </div>
                        </div>
                        <div class="row g-2 p-2">
                            <div class="col">
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="row">
                                <div class="col "> <button @click="sortTable('Financeira')" class=" txt-table-vendas text-nowrap"><strong>FINANCEIRA</strong></button></div>
                                <div class="col"> <button @click="sortTable('Plano')" class="txt-table-vendas text-nowrap"><strong>PLANO</strong></button></div>
                                <div class="col"> <button @click="sortTable('Ret')" class=" txt-table-vendas text-nowrap"><strong>RET</strong></button></div>
                                <div class="col"> <button @click="sortTable('EntMin')" class="txt-table-vendas text-nowrap"><strong>R$ ENT MIN</strong></button></div>
                                <div class="col"> <button @click="sortTable('EntPer')" class="txt-table-vendas text-nowrap"><strong>% ENT MIN</strong></button></div>
                                <div class="col"> <button @click="sortTable('Pmt')" class="txt-table-vendas text-nowrap"><strong>PMT</strong></button></div>
                                <div class="col"> <button @click="sortTable('Retorno')" class="txt-table-vendas text-nowrap"><strong>RETORNO</strong></button></div>
                                <div class="col"> <button @click="sortTable('TacCob')" class="txt-table-vendas text-nowrap"><strong>TAC COB</strong></button></div>
                                <div class="col"> <button @click="sortTable('TacDev')" class="txt-table-vendas text-nowrap"><strong>TAC DEV</strong></button></div>
                                <div class="col"> <button @click="sortTable('Coef')" class="txt-table-vendas text-nowrap"><strong>COEF</strong></button></div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <div class="col-1">
                        <button type="button" class="btn btn-lg btn-filtro" data-bs-dismiss="modal">
                        Fechar
                    </button>
                    </div>
                </div>
...
export default {
    ...
    data() {
        return {
            modal_fi: false,
            items: [
                { Financeira: 'Banco A', Plano: 'Plano X', Ret: 'R5', EntMin: 'R$ 0,00', EntMinPer: 10, Rentabilidade: 'R$ 6.778,80', Rebate:'R$ 0,00', Pmt: 'R$ 11.527,18', Spf: 0, Retorno: '6.0', TacCob: 'R$ 1.250,00', TacDev: 0, Coef: 0.10091, Parcela: 12 },
                { Financeira: 'Banco B', Plano: 'Plano Y', Ret: 'R5', EntMin: 'R$ 100,00', EntMinPer: 20, Rentabilidade: 'R$ 7.500,00', Rebate:'R$ 0,00', Pmt: 'R$ 10.000,00', Spf: 0,  Retorno: '6.0', TacCob: 'R$ 1.000,00', TacDev: 50, Coef: 0.105, Parcela: 10 },
                { Financeira: 'Banco C', Plano: 'Plano Z', Ret: 'R5', EntMin: 'R$ 200,00', EntMinPer: 30, Rentabilidade: 'R$ 8.200,00', Rebate:'R$ 0,00', Pmt: 'R$ 12.500,00', Spf: 0,  Retorno: '6.0', TacCob: 'R$ 1.500,00', TacDev: 75, Coef: 0.1075, Parcela: 8 }
            ],
    ...
    methods: {
        habilitar_fi() {
            console.log(
                "Aqui habilita o modal F&I ----- 0001"
            );
