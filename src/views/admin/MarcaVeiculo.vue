  ...
  <div>
    ...
    <nav class="navbar navbar-expand-lg rf_bg_form rf_texto rf_container">
      <div class="container-fluid">
        <div><i class="bi bi-sliders fs-5"> Administração - Marca Veículo </i></div>
        <div>
          <ul class="nav justify-content-end">
            ...
            <li class="nav-item">
              <a class="nav-link rf_texto_a disabled">Marca</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <form @submit.prevent="onSubmit" id="form">
        <div class="row g-2 p-2">
          <div class="card-title rf_texto gy-4">
            <i class="bi bi-person-fill-add fs-5"> Cadastrar Marca </i>
          </div>
        </div>
        <div class="row g-2 p-2">
          <div class="col">
      ...
      <div class="row g-2 p-2">
        ...
        <div class="col-3">
          <div class="input-group-append">
            <button class="btn btn-lg btn-secondary mt-2" type="button" @click="page = 1; retrieveMarcas();">
              Pesquisar
            </button>
          </div>
        </div>
    ...
    <div class="card rf_bg_form  rf_margin">
      <table class="table rf_texto">
        ...
        <tbody>
          <tr v-for=" item  in  marcas " :key="item.descricao">
