<template>
  ...
  <Navgator ref="navgator" :barraTitulo="' Administração - Combustível'" :titulo="'combustível'" />
    ...
    <form @submit.prevent="onSubmit">
      <div class="row g-2 p-2">
        <div class="card-title gy-4">
          <i class="bi bi-journal-text fs-5 icone_filtro"><span class="texto_filtro">Cadastrar Combustível</span></i>
        </div>
      </div>
      <div class="row g-2 p-2">
        <!--Descrição-->
    ...
    <div class="row g-2 p-2">
      ...
      <div class="col-1">
        <div class="input-group-append">
          <button class="btn btn-lg btn-filtro" type="button" @click="page = 1; retrieveCombustiveis();">
  ...
  <div class="card card-tabela g-2 p-2 rf_margin">
    ...
    <pagination v-if="combustiveis.length" :offset="totalPages" :total="totalItems" :limit="pageSize"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content card-container rf_texto">
        <div class="modal-header">
          <div class="card-title gy-4">
            <i class="bi bi-pencil-square fs-5 icone_kit"><span class="texto_kit">Editar Combustível</span></i>
          </div>
...
export default {
  ...
  methods: {
    ...
    async onSubmit() {
      try {
        console.log("Aqui")
        const resp = await fetch(`${process.env.VUE_APP_API_URL}combustivel`, {
          method: "POST",
    ...
    async update() {
      ...
      const response = await axios.put(
        `${process.env.VUE_APP_API_URL}combustivel/${this.edit_id}`,
        dados,
        { headers }
      );
