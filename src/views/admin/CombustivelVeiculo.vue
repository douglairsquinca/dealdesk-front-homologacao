  ...
  <div>
    ...
    <nav class="navbar navbar-expand-lg rf_bg_form rf_texto rf_container">
      <div class="container-fluid">
        <div><i class="bi bi-sliders fs-5"> Administração - Combustível </i></div>
        <div>
          <ul class="nav justify-content-end">
            ...
            <li class="nav-item">
              <a class="nav-link rf_texto_a disabled">Combustível</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <form @submit.prevent="onSubmit">
        <div class="row g-2 p-2">
          <div class="card-title rf_texto gy-4">
            <i class="bi bi-person-fill-add fs-5"> Cadastrar Combustível </i>
          </div>
        </div>
        <div class="row g-2 p-2">
          <!--Descrição-->
      ...
      <div class="row g-2 p-2">
        ...
        <div class="col-1">
          <div class="input-group-append">
            <button class="btn btn-lg btn-secondary mt-2" type="button" @click="page = 1; retrieveCombustiveis();">
              Pesquisar
            </button>
          </div>
        </div>
    ...
    <div class="card rf_bg_form g-2 p-2 rf_margin">
      <table class="table rf_texto">
        ...
        <tbody>
          <tr v-for="item in combustiveis" :key="item.descricao">
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rf_bg_form rf_texto">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Editar Combustível</h1>
